...
{
    WebServiceRequest *gwGetAll = [[WebServiceRequest alloc] init];
    [gwGetAll sendRequestToUrlPath:@"/api/gradedworks" forDataKeyName:@"Collection" from:self propertyNamed:@"gwGetAll"];
}
...
- (void)addNewGwItem:(NSDictionary *)newItem
{
    ...
    [gwAddNewItem sendRequestToUrlPath:@"/api/gradedworks" forDataKeyName:@"Item" from:self propertyNamed:@"editedGwItem"];
}
