...
- (void)viewDidLoad
{
    ...
    // Add an "edit" button to the left side of the nav bar
    // Look at self.editButtonItem reference info to learn what it does
...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (editingStyle == UITableViewCellEditingStyleDelete)
    {
        ...
        NSManagedObjectContext *context = [self.model.frc_professor managedObjectContext];
        // Delete the object from the collection
        [context deleteObject:[self.model.frc_professor objectAtIndexPath:indexPath]];
