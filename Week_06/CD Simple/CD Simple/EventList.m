...
{
    // How many "sections" should we create in the table view? (ask the data source)
    return [[self.model.frc_event sections] count];
}

- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    // For the specific passed in "section" argument, how many rows are in that section? (ask the data source)
