...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    {
        // Fetch the selected object
        NSManagedObject *o = [self.model.frc_album objectAtIndexPath:sender];
        //Configure the next VC
        AlbumView *vc = (AlbumView *)segue.destinationViewController;
        vc.model = self.model;
        vc.o = o;
        vc.title = [o valueForKey:@"albumName"];
    }
}

- (void)tableView:(UITableView *)tableView accessoryButtonTappedForRowWithIndexPath:(NSIndexPath *)indexPath
{
    [self performSegueWithIdentifier:@"toAlbumView" sender:indexPath];
}
