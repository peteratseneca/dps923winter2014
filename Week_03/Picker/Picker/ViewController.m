...
// self.model.cities is an NSArray of strings (NSString instances)

// How many scrolling components?
...
- (void)pickerView:(UIPickerView *)pickerView
    ...
    self.lblResult.text = [NSString stringWithFormat:@"Selected: %@",
                           [[self.model.cities objectAtIndex:row] description]];
}
